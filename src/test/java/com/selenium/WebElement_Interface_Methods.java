...
public class WebElement_Interface_Methods {
   ...
   //entering text into the focussed element
     driver.switchTo().activeElement().sendKeys("anny");
	...
	public void removeValuefromText_usingClearMethod() throws InterruptedException {
         ...
         driver.get("https://www.facebook.com/");
         Thread.sleep(2000);
         driver.findElement(By.id("email")).sendKeys("anny@gmai.com");
         Thread.sleep(2000);
         ...
         Thread.sleep(2000);
         driver.findElement(By.id("email")).sendKeys("againEnteranny@gmai.com");
         Thread.sleep(2000);
